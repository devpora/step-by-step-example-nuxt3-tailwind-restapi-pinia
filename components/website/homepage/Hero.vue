<template>
  <div
    class="py-32 mx-auto text-center sm:px-4 tails-selected-element bg-indigo-600 dark:bg-indigo-900"
  >
    <div class="container mx-auto max-w-7xl">
      ...
      >
        If you are ready to change the way you design websites, then you'll want
        to use our block builder to make it fun and easy!
      </div>
      <div
